        ...
        <div className="mt-14 flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-end">
          ...
          >
            <svg
              ...
              aria-hidden
            >
              {/* Official Android robot head (bugdroid) */}
              <path d="M17.523 15.341a.97.97 0 1 0 .002-1.94.97.97 0 0 0-.002 1.94m-11.046 0a.97.97 0 1 0 .002-1.94.97.97 0 0 0-.002 1.94m11.396-6.02 1.937-3.354a.4.4 0 0 0-.146-.55.402.402 0 0 0-.55.147l-1.962 3.397A12.2 12.2 0 0 0 12 7.875c-1.864 0-3.617.418-5.152 1.086L4.886 5.564a.402.402 0 1 0-.696.403l1.937 3.354C2.799 11.13.661 14.502.276 18.5h23.448c-.385-3.998-2.523-7.37-5.851-9.179" />
            </svg>
            <span className="flex flex-col leading-tight">
              <span className="text-[10px] uppercase tracking-[0.14em] text-muted-foreground">
                Coming soon to
