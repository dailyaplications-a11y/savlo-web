...
import deleteAccountData from "@/lib/legal/delete-account-es.json"

export const metadata: Metadata = {
  title: deleteAccountData.title,
  description: deleteAccountData.description,
  alternates: {
    canonical: "/es/delete-account",
    languages: {
...
export default function DeleteAccountPage() {
  return (
    <div className="bg-grain relative min-h-screen bg-background text-foreground">
      ...
      <LegalPage data={deleteAccountData} locale="es" type="delete-account" />
